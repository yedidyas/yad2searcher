...
const search = async (city, neighborhood, name, filesDir) => {
    return new Promise(async (resolve, reject) => {
        try {
        const res = await axios.get(`https://www.yad2.co.il/api/pre-load/getFeedIndex/realestate/forsale?city=${city}&neighborhood=${neighborhood}&property=1&rooms=4-4&price=1850000-2100000&parking=1&elevator=1`,
        {
            headers: {
